        ...
        <GlassCard className="p-8 md:p-12 flex flex-col items-center text-center gap-8 border-white/10 shadow-2xl bg-black/20">
          ...
          <div className="space-y-6 max-w-lg">
            ...
            <p className="text-lg text-slate-400 leading-relaxed">
              这里是 <span className="text-slate-200 font-medium">Liquid Blog</span> 的控制台，存放着我的思维碎片与技术实验。
              <br className="hidden md:block" />
              如果你想探索更完整的我——包括我的项目作品、详细经历以及更多维度的数字足迹，请通过下方的传送门前往我的主宇宙。
            </p>
          </div>

          {/* 核心操作区 */}
          <div className="flex flex-col w-full gap-6 pt-4">
            <Link href="https://your-personal-website.com" target="_blank" className="w-full flex justify-center">
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-white/5 w-full">
              <div className="flex flex-col items-center gap-2 group cursor-default">
                ...
                <span className="text-xs text-slate-500 uppercase tracking-wider">FullStack</span>
              </div>
              <div className="flex flex-col items-center gap-2 group cursor-default">
                <div className="p-2 rounded-lg bg-white/5 group-hover:bg-white/10 transition-colors">
              ...
              <div className="flex flex-col items-center gap-2 group cursor-default">
                ...
                <span className="text-xs text-slate-500 uppercase tracking-wider">Creative</span>
              </div>
            </div>
          </div>
